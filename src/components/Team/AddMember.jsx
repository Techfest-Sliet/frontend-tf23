...
function AddMember() {
  ...
  return (
      ...
      <div className="Popup-formdiv">
        ...
        <input className="Popup-forminput" value={name} type="text" onChange={(e)=>setName(e.target.value)}/>
        ...
        <input className="Popup-forminput" value={tfId} type="text" onChange={(e)=>setTfId(e.target.value)}/>
        <div className="Popup-formline"></div>
        ...
        <input className="Popup-forminput" type="text" value={email} onChange={(e)=>setEmail(e.target.value)}/>
      ...
      {/* <button class="myButton">Add Team Mate</button> */}
        ...
        <button class="Popup-btn" onClick={handleAdd}>Add Team Mate</button>
