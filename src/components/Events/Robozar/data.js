...
export const datasOfEvent = [
    {
        ...
        schedule: (<span><a rel='noopener noreferrer' href='https://drive.google.com/file/d/1vPmrI1hoLYymEL9KRCisGI89saKA-RZE/view?usp=sharing' style={{ textDecoration: "none", color: "white" }}>Problem Statement</a></span>),
        prizeMoney: "₹ 30,000",
        dateBefore: "11/03",
        coor: [{
            img: require('../../dummy.jpg'),
            nameOfEventCoordinator: "Satyam Sharma",
            phoneNo: (<span><a href="tel:7700076418" style={{ textDecoration: "none", color: "white" }}> 7700076418</a></span>),
            mail: (<span><a href='mailto:2140144@sliet.ac.in' style={{ textDecoration: "none", color: "white" }}>2140144@sliet.ac.in</a></span>)
        }]
    },
    {
        ...
        schedule: (<span><a rel='noopener noreferrer' href='https://drive.google.com/file/d/1rs2b20oihSlnnOADkzqmLtBtXqEvFRg6/view?usp=sharing' style={{ textDecoration: "none", color: "white" }}>Problem Statement</a></span>),
        prizeMoney: "₹ 21,000",
        dateBefore: "15/03",
        coor: [{
            img: require('../../dummy.jpg'),
            nameOfEventCoordinator: "Aarushi Jain",
            phoneNo: (<span><a href="tel:9352148289" style={{ textDecoration: "none", color: "white" }}> 9352148289 </a></span>),
            mail: (<span><a href='mailto:aarushisanghi@gmail.com' style={{ textDecoration: "none", color: "white" }}>aarushisanghi@gmail.com</a></span>)
        }]
    },
    {
        ...
        register: (<span><Link to={"/underConstruction"} rel='noopener noreferrer' href='https://www.google.com/' style={{ textDecoration: "none", color: "white" }}>Register Now</Link></span>),
        schedule: (<span><a rel='noopener noreferrer' href='https://drive.google.com/file/d/1HutIAQ539N62NMNNKZLH3_LDGNZWPWHN/view?usp=sharing' style={{ textDecoration: "none", color: "white" }}>Problem Statement</a></span>),
        prizeMoney: "₹ 33,000",
        dateBefore: "1/03",
        coor: [{
            img: require('../../dummy.jpg'),
            nameOfEventCoordinator: "Rishav Ranjan",
            phoneNo: (<span><a href="tel:7319956071" style={{ textDecoration: "none", color: "white" }}> 7319956071</a></span>),
            mail: (<span><a href='mailto:2236075@sliet.ac.in' style={{ textDecoration: "none", color: "white" }}>2236075@sliet.ac.in</a></span>)
        }]
    },
    {
        nameOfEvent: "Robowar",
        ...
        register: (<span><Link to={"/underConstruction"} rel='noopener noreferrer' href='https://www.google.com/' style={{ textDecoration: "none", color: "white" }}>Register Now</Link></span>),
        schedule: (<span><a rel='noopener noreferrer' href='https://drive.google.com/file/d/1XVTypT-bK0DZkH9LADu38mclg0u0gidy/view?usp=sharing' style={{ textDecoration: "none", color: "white" }}>Problem Statement</a></span>),
        prizeMoney: "₹ 45,000",
        dateBefore: "1/03",
        coor: [{
            img: require('../../dummy.jpg'),
            nameOfEventCoordinator: "Indra Kumar",
            phoneNo: (<span><a href="tel:9548304247" style={{ textDecoration: "none", color: "white" }}> 9548304247 </a></span>),
            mail: (<span><a href='mailto:nishupanchal466@gmail.com' style={{ textDecoration: "none", color: "white" }}>nishupanchal466@gmail.com</a></span>)
        }]
    },
    {
        ...
        register: (<span><Link to={"/underConstruction"} rel='noopener noreferrer' href='https://www.wikipedia.com/' style={{ textDecoration: "none", color: "white" }}>Register Now</Link></span>),
        schedule: (<span><a rel='noopener noreferrer' href='https://drive.google.com/file/d/1LbBzbZilt3oRFeDSmpUfthOikGWviV1_/view?usp=drivesdka' style={{ textDecoration: "none", color: "white" }}>Problem Statement</a></span>),
        prizeMoney: "₹ 16,000",
        dateBefore: "15/03",
        coor: [{
            img: require('../../dummy.jpg'),
        ...
        domainCoordinator: [
            {
                ...
                nameOfDomainCoordinator: "Tushar Chandra",
                phoneNoOfDomainCoordinator: (<span><a href="tel:9113444651" style={{ textDecoration: "none", color: "white" }}> 9113444651 </a></span>),
                mailOfDomainCoordinator: (<span><a href='mailto: 2040425@sliet.ac.in' > 2040425@sliet.ac.in</a></span>)
            }
        ]
    }
]