...
export const datasOfEvent = [
    {
        ...
        schedule: (<span><a rel='noopener noreferrer' target='_blank' href='https://drive.google.com/file/d/1vPmrI1hoLYymEL9KRCisGI89saKA-RZE/view?usp=sharing' style={{ textDecoration: "none", color: "white" }}>Problem Statement</a></span>),
        prizeMoney: "₹ 30,000",
        dateBefore: "11/03",
        coor: [{
