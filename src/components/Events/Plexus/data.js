...
export const datasOfEvent = [
    {
        ...
        schedule: (<span><a rel='noopener noreferrer' href='https://drive.google.com/file/d/1_B2_ivxzfKa-p--xK3EN9y6e0GIUjyV3/view?usp=share_link' style={{ textDecoration: "none", color: "white" }}>Problem Statement</a></span>),
        prizeMoney: "₹ 12,000",
        dateBefore: "15/03",
        coor: [{
    ...
    },
    {
        ...
        register: (<span><Link to={"/underConstruction"} rel='noopener noreferrer' href='https://www.wikipedia.com/' style={{ textDecoration: "none", color: "white" }}>Register Now</Link></span>),
        schedule: (<span><a rel='noopener noreferrer' href='https://drive.google.com/file/d/15xSbDOWM_0wyfwyw1Fup4D36vfj6XAtP/view?usp=share_link' style={{ textDecoration: "none", color: "white" }}>Problem Statement</a></span>),
        prizeMoney: "₹ 12,000",
        dateBefore: "15/03",
        coor: [
            {
    ...
    },
    {
        ...
        register: (<span><Link to={"/underConstruction"} rel='noopener noreferrer' href='https://www.wikipedia.com/' style={{ textDecoration: "none", color: "white" }}>Register Now</Link></span>),
        schedule: (<span><a rel='noopener noreferrer' href='https://drive.google.com/file/d/1pMTzeWZhvCkfqH4WIfg4eqyDIP5xLhSl/view?usp=share_link' style={{ textDecoration: "none", color: "white" }}>Problem Statement</a></span>),
        prizeMoney: "₹ 9,000",
        dateBefore: "15/03",
        coor: [{
            img: require('../../dummy.jpg'),
    ...
    },
    {
        ...
        register: (<span><Link to={"/underConstruction"} rel='noopener noreferrer' href='https://www.wikipedia.com/' style={{ textDecoration: "none", color: "white" }}>Register Now</Link></span>),
        schedule: (<span><a rel='noopener noreferrer' href='https://drive.google.com/file/d/1n1VbD1yICWe8Z6eTgDjfAQqEPi48oix1/view?usp=sharing' style={{ textDecoration: "none", color: "white" }}>Problem Statement</a></span>),
        prizeMoney: "₹ 14,000",
        dateBefore: "15/03",
        coor: [{
            img: require('../../dummy.jpg'),
