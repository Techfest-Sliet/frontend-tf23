            ...
            <div className='background-of-EventsPage'>
                <div className='eventContainer'>
                    <div className='insideCntiner'>
                        ...
                        <p>This Domain is a platform to attempt and make the best use of your knowledge in the food and chemical industry. It will help India become healthy and pollution free through projects on food development and events based on environment safety.</p>
                ...
                <div className='eventsBackgroundBottom' key={index}>
                    ...
                    <div className='eventBox'>
                        ...
                        <div className='LeftOfBox'>
                            ...
                            <h2 style={{ marginTop: "6px" }}>Prizes Worth <br /> {item.prizeMoney} </h2>
