            ...
            <div className='background-of-EventsPage'>
                <div className='eventContainer'>
                    <div className='insideCntiner'>
                        ...
                        <p>The mega domain of Kermis focuses on non-tech events including gaming events. Aiming to promote the era of e-sports among the building students. Events like BGMI, Mini Militia and CS GO.</p>
