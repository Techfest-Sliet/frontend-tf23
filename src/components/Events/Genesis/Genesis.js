            ...
            <div className='background-of-EventsPage'>
                <div className='eventContainer'>
                    <div className='insideCntiner'>
                        ...
                        <p>The outstanding ones are those who do not limit themselves to a point and keep on triggering to create better.
                            Make yourself a part of Genesis Domain and witness young yet second to none entrepreneurs presenting extraordinary ideas.
                        </p>
